...
function page() {
  return (
    <Fragment>
      ...
      <section className="px-12 sm:px-14 py-16 md:px-16 lg:px-20 xl:px-24 mb-20 bg-[#EFF7F2] text-center gap-10 lg:text-start flex flex-col items-center lg:items-start">
      ...
      <section className="px-12 sm:px-14 mb-20 md:px-16 lg:px-20 xl:px-24 text-center lg:text-start flex flex-col items-center lg:items-start gap-7">
