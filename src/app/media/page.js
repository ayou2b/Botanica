...
function page() {
  return (
    <Fragment>
      ...
      <section className="lg:h-[90vh] bg-[#EFF7F2] w-full text-center py-16 lg:text-start  px-12 sm:px-14 md:px-16 lg:px-20 xl:px-24 mb-20 flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] gap-10 flex flex-col lg:flex-row lg:justify-between items-center">
      ...
      <section className="mb-20 text-center px-12 sm:px-14 md:px-16 lg:text-start lg:items-start lg:px-20 xl:px-24 flex items-center justify-center w-full">
