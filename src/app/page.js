...
export default function Home() {
  ...
  return (
    <Fragment>
      ...
      <section
        className="w-full h-[90vh] text-white p-12 sm:p-14 md:p-16 lg:p-20 xl:p-24 mb-20 text-center flex flex-col items-center gap-40 justify-center lg:text-start lg:items-start"
        style={{
      ...
      >
        <div className="flex flex-col transition-all gap-6 lg:gap-10 max-w-lg">
      ...
      <section className="text-center px-12 sm:px-14 md:px-16 lg:px-20 xl:px-24 mb-20 flex flex-col items-center justify-center gap-10 lg:flex-row lg:justify-between lg:text-start">
      ...
      <section className="text-center px-12 sm:px-14 md:px-16 lg:px-20 xl:px-24 mb-20 flex flex-col items-center lg:items-start gap-10">
      ...
      <section className="bg-[#EFF7F2] w-full mb-20 text-center px-12 sm:px-14 md:px-16 lg:px-20 xl:px-24 py-20 flex flex-col items-center justify-center lg:flex-row lg:justify-between gap-10">
      ...
      <section className="text-center px-12 sm:px-14 md:px-16 lg:px-20 xl:px-24 mb-20 lg:text-start">
      ...
      <section className="bg-[#0B0706] w-full px-12 sm:px-14 md:px-16 lg:px-20 xl:px-24 mb-20 py-20 text-center lg:text-start lg:items-start flex flex-col items-center justify-center gap-10">
