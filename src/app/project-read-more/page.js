...
function Page() {
  ...
  return (
    <Fragment>
      ...
      <section className="mt-28 mb-20 px-12 sm:px-14 md:px-16 lg:px-20 xl:px-24 flex flex-col items-center lg:items-start gap-7  text-center lg:text-start">
      ...
      <section className="mb-20 bg-[#EBF0F9] py-20 px-12 sm:px-14 md:px-16 lg:px-20 xl:px-24 text-center lg:text-start">
        <div className="flex flex-col items-center gap-10 md:grid md:grid-cols-2">
          <div className="flex flex-col items-center lg:items-start gap-4 lg:flex-row max-w-md">
            <Image
              src={icon_1}
              alt=""
