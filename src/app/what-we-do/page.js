...
function Page() {
  ...
  return (
    <Fragment>
      ...
      <section className="h-[90vh] px-12 mb-20 sm:px-14 md:px-16 lg:px-20 xl:px-24 text-center flex gap-10 lg:text-start lg:flex-row-reverse lg:justify-between flex-col items-center justify-center">
        <Image
          src={hero_image}
          alt=""
      ...
      <section className="bg-[#EFF7F2] px-12 w-full mb-20 py-20 sm:px-14 md:px-16 lg:px-20 xl:px-24  text-center lg:text-start flex flex-col items-center lg:items-start gap-10">
      ...
      <section className="text-center px-12 sm:px-14 md:px-16 lg:px-20 xl:px-24 mb-20">
